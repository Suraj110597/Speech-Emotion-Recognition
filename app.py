...
def load_model():
   model=tf.keras.models.load_model('/content/drive/MyDrive/AlmaBetter/Capstone Projects/Speech Emotion Recognition - Sagar Rokad/Models/vgg_fine_tuning.hdf5')
   return model
